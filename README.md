...
```bash
# Get the Mac Mini's Tailscale IP first:
#   On Mac Mini: tailscale ip -4
# Then from MacBook:
ssh -L 3000:127.0.0.1:3000 -L 8317:127.0.0.1:8317 $(whoami)@<mac-mini-tailscale-ip>
```
...
All steps below run on the **Mac Mini** (the machine you SSH into):
...
**Passwordless SSH with Key Authentication**
